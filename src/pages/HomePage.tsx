    ...
    <>
        ...
        <div className="container grid md:grid-cols-2 gap-8 md:gap-16 items-center py-12">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                to="/catalogue"
                className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full text-xs uppercase tracking-[0.25em] hover:bg-primary/90 transition-colors group"
              >
              ...
              <Link
                to="/histoire"
                className="inline-flex items-center justify-center text-xs uppercase tracking-[0.25em] text-foreground hover:text-primary transition-colors px-4 py-4"
              >
                Notre histoire
              </Link>
            </div>
          ...
          >
            <div className="aspect-[4/5] rounded-md overflow-hidden bg-muted shadow-elegant">
              <img
                src={heroImg}
            ...
            >
              <p className="text-[10px] uppercase tracking-[0.2em] text-primary mb-2">Signature</p>
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-10 md:gap-16">
            {[
              ...
              >
                <v.icon className="w-6 h-6 text-primary mb-4" strokeWidth={1.2} />
      ...
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          ...
          >
            <p className="text-[10px] uppercase tracking-[0.3em] text-background/70 mb-4">La matière</p>
            <h2 className="font-serif text-4xl md:text-6xl text-background leading-tight max-w-3xl mx-auto text-balance">
      ...
      <section className="py-20 md:py-28">
        <div className="container">
          <div className="flex items-end justify-between mb-12">
            <div>
              <p className="text-[10px] uppercase tracking-[0.3em] text-primary mb-3">Sélection Atelier</p>
              <h2 className="font-serif text-4xl md:text-5xl text-foreground">Pièces du moment</h2>
            </div>
            <Link
              to="/catalogue"
              className="hidden sm:inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-foreground hover:text-primary border-b border-foreground hover:border-primary pb-1 transition-colors"
            >
              Tout voir
          ...
          <div className="text-center mt-12 sm:hidden">
            <Link
              to="/catalogue"
              className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-primary border-b border-primary pb-1"
            >
